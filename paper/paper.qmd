...
#| echo: false
#| fig.cap: "System dynamics model. $S$ and $I$ are the number of susceptible and infected patients, respectively; $A$ and $D$ are the rates of admitted and discharged patients, respectively; $p$ is the community colonisation rate; $\\beta$ is the transmission coefficient; and $r$ is the rate of random (*de novo*) infection."
...
### Calibration of the \acr[first_use=TRUE]{SD} model
...
```{r}
# compare ABM community colonisation rate to SD model p
mean_sims %>% 
  summarise(mean = mean(`community-colonisation-rate`),
            sd = sd(`community-colonisation-rate`))
```
