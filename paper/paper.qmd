...
Computer simulation can be used to model the spread of infectious diseases, and has been used to describe the transmission of pathogens in healthcare settings, such as \acr{MRSA} [@jaramilloAgentBasedModel2015] and \acr{SARS-CoV-2} [@kerrCovasimAgentbasedModel2021].
...
To assess the impact of different infection control interventions, we systematically varied one parameter at a time while holding all other parameters fixed at their posterior mean values; the resulting number of nosocomial infections during the outbreak period was recorded. The parameters examined reflected modifiable infection control practices: antimicrobial prescription rates, the mean delay before transferring infected patients to single-occupancy rooms, toilet cleaning frequency, and toilet cleaning effectiveness.
