...
outbreak_variables <- list("outbreak-start" = list(min=outbreak_start - 90,
                           ...
                           "o-toilet-frequenting-rate" = list(min=pre_outbreak_variables[["toilet-frequenting-rate"]]$min,
                                                              max=pre_outbreak_variables[["toilet-frequenting-rate"]]$max + 0.5 * pre_outbreak_variables[["toilet-frequenting-rate"]]$max,
                                                              qfun='qunif'),
                           "o-toilet-contamination-effect" = list(min=pre_outbreak_variables[["toilet-contamination-effect"]]$min,
                                                                  max=min(0.99, pre_outbreak_variables[["toilet-contamination-effect"]]$max + 0.5 * pre_outbreak_variables[["toilet-contamination-effect"]]$max),
                                                                  qfun='qunif'),
