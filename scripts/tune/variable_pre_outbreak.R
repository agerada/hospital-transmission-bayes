...
outbreak_variables <- list("outbreak-start" = list(min=outbreak_start - 90,
                           ...
                           "o-toilet-frequenting-rate" = list(min=pre_outbreak_variables[["toilet-frequenting-rate"]]$min,
                                                              max=pre_outbreak_variables[["toilet-frequenting-rate"]][[upper_bound]] + upper_bound_scale * pre_outbreak_variables[["toilet-frequenting-rate"]][[upper_bound]],
                                                              qfun='qunif'),
                           "o-toilet-contamination-effect" = list(min=pre_outbreak_variables[["toilet-contamination-effect"]]$min,
                                                                  max=min(0.99, pre_outbreak_variables[["toilet-contamination-effect"]][[upper_bound]] + upper_bound_scale * pre_outbreak_variables[["toilet-contamination-effect"]][[upper_bound]]),
                                                                  qfun='qunif'),
                           "o-toilet-cleaning-effect" = list(min=max(0.01, pre_outbreak_variables[["toilet-cleaning-effect"]][[lower_bound]] - lower_bound_scale * pre_outbreak_variables[["toilet-cleaning-effect"]][[upper_bound]]),
                           ...
                           "o-community-colonisation-rate" = list(min=pre_outbreak_variables[["community-colonisation-rate"]]$min,
                                                                  max=pre_outbreak_variables[["community-colonisation-rate"]][[upper_bound]] + upper_bound_scale * pre_outbreak_variables[["community-colonisation-rate"]][[upper_bound]],
                                                                  qfun='qunif'),
                           ...
                           "c-toilet-cleaning-rate" = list(min=pre_outbreak_variables[["toilet-cleaning-rate"]]$min,
                                                           max=pre_outbreak_variables[["toilet-cleaning-rate"]][[upper_bound]] + upper_bound_scale * pre_outbreak_variables[["toilet-cleaning-rate"]][[upper_bound]],
                                                           qfun='qunif'),
